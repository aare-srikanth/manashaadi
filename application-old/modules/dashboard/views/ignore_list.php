...
.navbar-nav>li {
   ...
   <div class="main container-fluid">
	...
	<?php if(isset($get_my_ignorelist) && count($get_my_ignorelist) >0) {
               
               $nb_elem_per_page = 2;
               $page = isset($_GET['page'])?intval($_GET['page']-1):0;
               $get_my_ignorelist = (array)$get_my_ignorelist;
               $number_of_pages = intval(count($get_my_ignorelist)/$nb_elem_per_page)+1;
...
<a class="previous_ms" href='./ignore_list?page=<?=$page-1?>'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/><path d="M0 0h24v24H0z" fill="none"/></svg> </a>


<?php }


echo '<h4>Ignored List</h4>';
...
<a class="next_ms" href='./ignore_list?page=<?=$page+1?>'>
...
<?php } ?>
       ...
       <?php 
            ...
            ?>
              ...
              foreach(array_slice($get_my_ignorelist, $page*$nb_elem_per_page, $nb_elem_per_page) as $value){  
          ...
          $view_class="";
           ...
           ?>
                        ...
                        <p class="view_update inline-icon-manashaddi <?php echo $view_class;  ?>" data-id="<?php echo $value['profile_id'];  ?>" title="Mark as Viewed" ><i class="fa fa-eye"></i></p>
                        <p class="shortlist_update  inline-icon-manashaddi <?php echo $shortlist_class;  ?>" data-id="<?php echo $value['profile_id'];  ?>" title="Shortlist" ><i class="fa fa-bookmark" style="color:#006A96;"></i></p>
                        <p class="ignore_update  inline-icon-manashaddi <?php echo $ignored_class;  ?>" data-id="<?php echo $value['profile_id'];  ?>" title="Ignore" ><i class="fa fa-times-circle" style="color:#ff5a60"></i></p>
