...
<a class="previous_ms" href='./recently_viewed?page=<?=$page-1?>'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/><path d="M0 0h24v24H0z" fill="none"/></svg> </a>
...
<a class="next_ms" href='./recently_viewed?page=<?=$page+1?>'>
...
<?php } ?>
       ...
       <?php 
            ...
            ?>
              ...
              foreach(array_slice($get_recent_views, $page*$nb_elem_per_page, $nb_elem_per_page) as $value){  
                  ...
                  <div class="col-md-12 person-details">
                    ...
                    <div class="col-xs-8 pull-right" style="padding:10px 5px;">
                        <div class="col-xs-12">
						  ...
						  <div class="col-xs-4 viewProfile-ms text-center"><a href="<?php echo site_url();?>dashboard/search/profile/<?php echo $value['profile_id'];?>" data-id="<?php echo $value['profile_id'];  ?>" target="_blank" class="details">View Profile</a> </div>
                        </div>
          ...
          $view_class="";
           ...
           ?>
                        ...
                        <p class="view_update inline-icon-manashaddi <?php echo $view_class;  ?>" data-id="<?php echo $value['profile_id'];  ?>" ><i class="fa fa-eye"></i></p>
                        <p class="shortlist_update  inline-icon-manashaddi <?php echo $shortlist_class;  ?>" data-id="<?php echo $value['profile_id'];  ?>" ><i class="fa fa-bookmark" style="color:#006A96;"></i></p>
                        <p class="ignore_update  inline-icon-manashaddi <?php echo $ignored_class;  ?>" data-id="<?php echo $value['profile_id'];  ?>" ><i class="fa fa-times-circle" style="color:#ff5a60"></i></p>
