...
<div class="modal"  style="display: none;" aria-hidden="true">
            ...
            <div class="all-images search_profile" style="clear:both; padding-top:50px;">
               ...
               <ul class="bxslider">
                  ...
                  <?php if(isset($images_info) && count($images_info) > 0) { $ap_image=0; foreach($images_info as $value) {  ?>
                        ...
                        <img class="profile_img" width="25%" src="<?php echo $value['applicationphotopath'].".jpeg"; ?>"> 
   ...
   <div class="view-profile col-xs-12 col-md-12" style="margin:5px 10px;padding:10px;">
...
for($i=0;$i<count($profession);$i++){
    ...
    <div class="view-profile col-xs-12 col-md-12" style="margin:5px 10px; padding:10px;">
                  ...
                  <div class="view-profile col-xs-12 col-md-12 col-offset-md-2" style="margin:5px 10px; padding:10px;">
                  <div class="profile-heading">
