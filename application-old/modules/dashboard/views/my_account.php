   ...
   <div class="main container-fluid">
      <div class="">
		  ...
		  <div class="userbox-ms">
                    ...
                    <li><a href="<?php echo site_url(); ?>dashboard">  Edit Preferences</a><li>
       ...
       <li><a href="<?php echo site_url(); ?>dashboard/contact_list"><p id="contact_list"><i class="fa fa-address-book-o"></i> Contact List (<?php echo count($contact_list); ?>)</p></a></li>
		  ...
		  <div class="title-profile-ms">
		       ...
		       <?php if(isset($get_all_records) && count($get_all_records) >0) {
               
               $nb_elem_per_page = 2;
               $page = isset($_GET['page'])?intval($_GET['page']-1):0;
               $get_all_records = (array)$get_all_records;
               $number_of_pages = intval(count($get_all_records)/$nb_elem_per_page)+1;
...
<a class="previous_ms" href='./my_account?page=<?=$page-1?>'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/><path d="M0 0h24v24H0z" fill="none"/></svg> </a>

<?php }


echo '<h4>New Matches</h4>';
...
<a class="next_ms" href='./my_account?page=<?=$page+1?>'>
...
<?php } ?>
       ...
       <?php 
            ...
            ?>
               ...
               if(isset($get_all_records) && count($get_all_records) >0) { 
               ...
               foreach(array_slice($get_all_records, $page*$nb_elem_per_page, $nb_elem_per_page) as $value){ 
            ...
            ?>
                  ...
                  <div class="col-md-12 person-details">
                    ...
                    <div class="col-xs-8 pull-right" style="padding:10px 5px;">
						...
						<div class="col-xs-4 viewProfile-ms"><a href="<?php echo site_url();?>dashboard/search/profile/<?php echo $value['profile_id'];?>" data-id="<?php echo $value['profile_id'];  ?>" target="_blank" class="details text-center">View My Profile</a> </div>
                        </div>
           ...
           ?>
						...
						<a>
                           ...
                           <p class="ex-p col-xs-12 contact_now text-center" data-id="<?php echo $value['profile_id'];  ?>" > Contact Now</p>
                           
                           <?php }else{ ?>
                           
                           <a  class="ex-p col-xs-12 update-contact-now text-center" data-id="<?php echo $value['profile_id'];  ?>" >   Contact Now</a>
