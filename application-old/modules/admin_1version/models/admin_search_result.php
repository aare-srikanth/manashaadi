            ...
            <div class="result">
               ...
               <div class="result-body">
                     <div class="result-body-left">
                        ...
                        <?php 
                        if($search_sub_rec['0']['image']!="") { ?>
                        <a target="_blank" data-fancybox="gallery" href="<?php echo site_url();?>images/profilepics/<?php echo $search_sub_rec['0']['image'];?>">
                        <img src="<?php echo site_url();?>images/profilepics/<?php echo $search_sub_rec['0']['image'];?>"></a>
                        <?php } 
                        else{ ?>
                        ...
                        <table width="100%">
                           ...
                           <b style="padding-top: 40px;font-weight: 500;font-size: 22px; color: blue;display: flex;"><a href="#"> Load more PHOTOS..</b></a>
                        <?php
                           // $i=0;
...
<style>   
   .pagination > li > a, .pagination > li > span{background-color:#eae6e6;color:black;}
