...
class Employee_model extends CI_Model {
    ...
    public function save_reminder($cust_id, $rem_date){
        $sql_query = "UPDATE ms_profilesetting set rem_date='".$rem_date."' WHERE ms_id=".$cust_id;
        $this->db->query($sql_query);
    }
    ...
    public function update_profile_owner($cust_id,$emp_id){
        $sql_query = "UPDATE ms_profilesetting set profileowner=".$emp_id." WHERE ms_id=".$cust_id;
        $this->db->query($sql_query);
    }
}
