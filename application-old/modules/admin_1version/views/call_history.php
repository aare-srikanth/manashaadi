...
<style>
    #cust_call_log_list {  list-style-type: none;  height:95%;  color:black;}

    #cust_call_log_list li { margin-top:1vw; width:100%; }

    .btn_save_reg { margin-left:20px;}

    #btn_view_call_history{ width:60%; height: 100%; float: left; font-size:1em; }

    #btn_log_call_history{  width:60%; height: 100%; float: left; font-size:1em;}
