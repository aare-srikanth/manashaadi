...
class Subcaste extends CI_Controller {
	
	public $headerPage = 'admin_header';
	public $addPage    = 'subcaste-add';	   
	public $editPage   = 'subcaste-edit';   
	public $listPage   = 'subcaste';		  

	public $listPage_redirect = '/admin/Subcaste';		 
	public $addPage_redirect  = '/admin/Subcaste/add/';	
	public $editPage_redirect = '/admin/Subcaste/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Subcaste_model','my_model');  
	...
	{ 
		...
		$data['categories'] = $this->my_model->get_all_categories();
		$this->load->view($this->headerPage);
