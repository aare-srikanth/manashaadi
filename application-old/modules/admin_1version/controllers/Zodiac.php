...
class Zodiac extends CI_Controller {
	...
	public $addPage    = 'zodiac-add';	   
	public $editPage   = 'zodiac-edit';   
	public $listPage   = 'zodiac';		  

	public $listPage_redirect = '/admin/Zodiac';		 
	public $addPage_redirect  = '/admin/Zodiac/add/';	
	public $editPage_redirect = '/admin/Zodiac/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Zodiac_model','my_model');  
