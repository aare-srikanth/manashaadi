...
class Profession extends CI_Controller {
	...
	public $addPage    = 'profession-add';	   
	public $editPage   = 'profession-edit';   
	public $listPage   = 'profession';		  

	public $listPage_redirect = '/admin/Profession';		 
	public $addPage_redirect  = '/admin/Profession/add/';	
	public $editPage_redirect = '/admin/Profession/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Profession_model','my_model');  
