...
class Religion extends MX_Controller {
	...
	public $addPage    = 'religion-add';	   
	public $editPage   = 'religion-edit';   
	public $listPage   = 'religion';		  

	public $listPage_redirect = '/admin/Religion';		 
	public $addPage_redirect  = '/admin/Religion/add/';	
	public $editPage_redirect = '/admin/Religion/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Religion_model','my_model');  
