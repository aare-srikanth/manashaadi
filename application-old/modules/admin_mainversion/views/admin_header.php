...
<!-- /online fonts -->
    ...
    <!-- <link rel="stylesheet" href="<?php echo site_url(); ?>assets/css/mi_home.css"/> -->
...
<nav class="navbar navbar-expand-md navbar-bg" >
    ...
    <ul class="navbar-nav">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown_target">
			<a href="<?php echo site_url();?>admin/assign_profiles" class="dropdown-item">Un Assigned Profiless</a>
			<div class="dropdown-divider"></div>   
