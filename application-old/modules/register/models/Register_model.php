		...
		public function add_property_info()
		{
			...
			$set_data = array
			    (
			      ...
			      'property_type'=>mysqli_real_escape_string($this->get_mysqli(),$this->input->post('property_type',TRUE)),
			      'property_value'=>mysqli_real_escape_string($this->get_mysqli(),$this->input->post('property_value',TRUE)),
			      'property_desc'=>mysqli_real_escape_string($this->get_mysqli(),$this->input->post('property_description',TRUE))
			    );
