...
class Country extends MX_Controller
{
	...
	public $addPage    = 'country-add';
	public $editPage   = 'country-edit';
	public $listPage   = 'country';

	public $listPage_redirect = '/admin/Country';
	public $addPage_redirect  = '/admin/Country/add/';
	public $editPage_redirect = '/admin/Country/edit/';

	public function __construct()
	{
		parent::__construct();
		$this->load->model('Country_model', 'my_model');
