					...
					<div class="page-content">
							...
							<div class="ace-settings-box clearfix" id="ace-settings-box">
								...
								<div class="pull-left width-50">
									...
									<!-- #section:Aboutus/sidebar.options -->
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Couple Names : </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  required name="title" placeholder="Enter Couple Names Seperated bY Comma" value="<?php echo $record['title'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
										<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Precious Image : </label>
										<div class="col-sm-9">
											<img style="width:150px;height:100px;" src="<?php echo site_url();?>images/successstories/<?php echo $record['image'];?>"/>
										</div>
									</div>
								 <div class="form-group">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Content  : </label>
										   ...
										   <textarea name="content"><?php echo stripcslashes(str_replace("\n","", $record['content'])); ?></textarea>
										  <script>
									...
									<div class="clearfix form-actions">
										...
										<div class="col-md-offset-3 col-md-9">
											...
											<a class="btn" href="<?php echo ADMIN_URL;?>successstories">
