...
<title>Manashaadi.com - Telugu Marriage Bureau, Best  Matrimony Site In India</title>
<meta name="description" content="ManaShaadi.com - One of the Telugu Marriage Bureau  and  most successful Best Matrimony sites in India. Telugu Matrimonial sites allow to FREE Registration.">
<meta name="title" content="Manashaadi.com - Telugu Marriage Bureau, Best  Matrimony Site In India">
<meta name="keywords" content="Telugu Marriage Bureau, Best matrimony sites in India, telugu matrimonial sites, Marriage bureau, Shaadi, Telugu Matrimony">
<link rel="canonical" href="https://www.manashaadi.com/">
<meta name="robots" content="INDEX, FOLLOW, ARCHIVE">
<meta property="og:locale" content="en_US" /> 
<meta property="og:type" content="website" />
<meta property="og:title" content="Manashaadi.com - Telugu Marriage Bureau, Best  Matrimony Site In India" /> 
<meta property="og:description" content="ManaShaadi.com - One of the Telugu Marriage Bureau  and  most successful Best Matrimony sites in India. Telugu Matrimonial sites allow to FREE Registration." /> 
<meta property="og:url" content="https://www.manashaadi.com/"/>
<meta property="og:site_name" content="Telugu Marriage Bureau" /> 
<meta property="og:image" content="https://www.manashaadi.com/design/img/slider/Manashaddi.jpg" /> 
          ...
          <?php  if($this->session->userdata('user_email') == '' &&  $this->session->userdata('user_id') == '')
           ...
           <nav class="navbar navbar-default navbar-fixed-top">  
            ...
            <?php  }else{ ?>
                ...
                <nav class="navbar navbar-default navbar-fixed-top dashboard_navbar"> 
            <!--logo-->
            <a href="<?php echo site_url().'dashboard/my_account';?>" id="dashboard_logo" class="pull-left nav-brand"> 
                <img src="<?php echo site_url();?>design/img/logo.png" alt="logo">
            </a>
...
<ul class="nav navbar-nav bd-navbar-nav flex-row">
  ...
  { echo "active-menu"; } ?>" >
      <a href="<?php echo site_url();?>dashboard/imagesadd"><i class="fa fa-edit"></i> Edit My Profile </a>
  ...
  <li class="<?php if($this->uri->segment(2)=="userinfo") { echo "active-menu"; } ?> dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <img src="<?php echo $profile_pic[0]['applicationphotopath'].".jpeg"; ?>" width="30px" height="30px" style="border-radius:50%;" >
                        <?php }else{ ?>
