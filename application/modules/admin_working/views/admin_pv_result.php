<div class="row">
            ...
            <div class="card" style="border-style: none;background-color: white">
                ...
                <!-- <form class="form-horizontal" method="POST" action="<?php echo site_url();?>admin/validation_result"> -->
                 ...
                 <div class="form-group row"> 
						...
						<label for="Gender"> <b>Payment</h5></b>     
                        <label style="padding-left: 30px;" class="radio-inline "><input  type="radio"  name="Pament" value="female">     Paid</label>
                        <label style="padding-left: 30px;" class="radio-inline "><input type="radio"  name="Pament" value="male">     Free</label>
                        <label style="padding-left: 30px;" class="radio-inline "><input type="radio" checked="checked"  name="gender" value="" >     Both</label>
        ...
        <!-- <a href="<?php echo site_url();?>admin/profile_validation"><button class="submit"> Back to Search</button></a>    -->
                        ...
                        <div class="table100-body" >
                            <tbody style="text-align: left;">
                             <?php $slno=$this->uri->segment(4,0);
                                ...
                                <td class="cell4"><a href="<?php echo site_url();?>admin/edit_profile/<?php echo $value['id'];?>"><button >Edit</button></a></td> 
                                <td class="cell4">
                <a target="_blank" href=""><button>Del</button></a></td>       
                                <td class="cell12">
