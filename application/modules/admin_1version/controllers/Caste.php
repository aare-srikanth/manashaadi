...
class Caste extends CI_Controller {
	...
	public $addPage    = 'caste-add';	   
	public $editPage   = 'caste-edit';   
	public $listPage   = 'caste';		  

	public $listPage_redirect = '/admin/Caste';		 
	public $addPage_redirect  = '/admin/Caste/add/';	
	public $editPage_redirect = '/admin/Caste/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Caste_model','my_model');  
