...
class Registeredusers extends CI_Controller {
	...
	public $listPage   = 'registeredusers';	
	public $viewPage   = 'users-view';		  

	public $listPage_redirect = '/admin/Registeredusers';		 
	public $addPage_redirect  = '/admin/Registeredusers/add/';	
	public $editPage_redirect = '/admin/Registeredusers/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Registeredusers_model','my_model');  
	...
	public function edit($id)
	{
		...
		$data['images'] = $this->my_model->get_images($user_id);
		$data['msg'] ='';
		if($this->input->post('submit') != '')
		{
	...
	{
		$data['msg'] ='';
		$statu = ($status == 1 ? 'In-active' : 'Active');
		if($id)
		{
