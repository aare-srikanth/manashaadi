...
class Gothram extends CI_Controller {
	
	public $headerPage = 'admin_header';
	public $addPage    = 'gothram-add';	   
	public $editPage   = 'gothram-edit';   
	public $listPage   = 'gothram';		  

	public $listPage_redirect = '/admin/Gothram';		 
	public $addPage_redirect  = '/admin/Gothram/add/';	
	public $editPage_redirect = '/admin/Gothram/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Gothram_model','my_model');  
