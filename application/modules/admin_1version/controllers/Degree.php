...
class Degree extends CI_Controller {
	...
	public $addPage    = 'degree-add';	   
	public $editPage   = 'degree-edit';   
	public $listPage   = 'degree';		  

	public $listPage_redirect = '/admin/Degree';		 
	public $addPage_redirect  = '/admin/Degree/add/';	
	public $editPage_redirect = '/admin/Degree/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Degree_model','my_model');  
