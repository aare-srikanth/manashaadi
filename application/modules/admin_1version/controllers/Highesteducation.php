...
class Highesteducation extends CI_Controller {
	
	public $headerPage = 'admin_header';
	public $addPage    = 'heighsteducation-add';	   
	public $editPage   = 'heighsteducation-edit';   
	public $listPage   = 'heighsteducation';		  

	public $listPage_redirect = '/admin/Highesteducation';		 
	public $addPage_redirect  = '/admin/Highesteducation/add/';	
	public $editPage_redirect = '/admin/Highesteducation/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Highesteducation_model','my_model');  
