...
class Dashboard_model extends CI_Model {
    ...
    {
        $this->db->select('photos_id,MS_id,photoname,uploaded_date,ismain');
    ...
    public function delete_image_row($id)
    {
        ...
        $path_to_file1 = 'images/profilepics/'.$user_id.'/'.$app_array[6].'.jpeg';
        
       $path_to_file2 = 'images/profilepics/'.$user_id.'/'.$full_array[6].'.jpeg';
	...
	public function add_record($ImgData,$main_photo){
