...
.navbar-nav>li {
   ...
   <div class="main container-fluid">
	...
	<?php if(isset($get_my_shortlist) && count($get_my_shortlist) >0) {
               
               $nb_elem_per_page = 2;
               $page = isset($_GET['page'])?intval($_GET['page']-1):0;
               $get_my_shortlist = (array)$get_my_shortlist;
               $number_of_pages = intval(count($get_my_shortlist)/$nb_elem_per_page)+1;
...
<a class="previous_ms" href='./my_shortlist?page=<?=$page-1?>'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/><path d="M0 0h24v24H0z" fill="none"/></svg> </a>


<?php }


echo '<h4>My Shortlist</h4>';
...
<a class="next_ms" href='./my_shortlist?page=<?=$page+1?>'>
...
<?php } ?>
       ...
       <?php 
            ...
            ?>
              ...
              foreach(array_slice($get_my_shortlist, $page*$nb_elem_per_page, $nb_elem_per_page) as $value){  
            ...
            ?>
                  ...
                  <div class="col-md-12 person-details">
                    ...
                    <div class="col-xs-8 pull-right" style="padding:10px 5px;">
                        <div class="col-xs-12">
                          <div class="col-xs-6 no-padding"><h4 class="wd-70"><?php echo $value['first_name'] . ' ' . $value['last_name'];?><span> (ID:<?php echo $value['profile_id'];?>)</span></h4></div>
						  <div class="col-xs-6 viewProfile-ms text-center"><a href="<?php echo site_url();?>dashboard/search/profile/<?php echo $value['profile_id'];?>" data-id="<?php echo $value['profile_id'];  ?>" target="_blank" class="details">View Profile</a> </div>
                        </div>
                        <div class="col-xs-6 content-ms">
                              ...
                              <div class="list" style="font-size: 13px; line-height: 22px;">
                                 ...
                                 <div class="col-xs-12 no-padding"><?php echo ucwords($value['heighst_education']);?></div>
          ...
          $view_class="";
           ...
           for($j=0;$j<=count($recently_viewed);$j++){
                ...
                if ($value['id']==$recently_viewed[$j]['to_msid'])
                {
           ...
           for($j=0;$j<=count($shortlisted_count);$j++){
                ...
                if ($value['id']==$shortlisted_count[$j]['to_msid'])
                {
           ...
           for($j=0;$j<=count($ignored_count);$j++){
                ...
                if ($value['id']==$ignored_count[$j]['to_msid'])
                {
           ...
           for($j=0;$j<=count($contact_list);$j++){
                ...
                if ($value['id']==$contact_list[$j]['to_MSid'])
                {
           ...
           ?>
                        ...
                        <p class="view_update inline-icon-manashaddi <?php echo $view_class;  ?>" data-id="<?php echo $value['profile_id'];  ?>" ><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="Mark as Viewed"></i></p>
                        <p class="shortlist_update  inline-icon-manashaddi <?php echo $shortlist_class;  ?>" data-id="<?php echo $value['profile_id'];  ?>" ><i class="fa fa-bookmark" style="color:#006A96;"data-toggle="tooltip" data-placement="top" title="Shortlisted"></i></p>
                        <p class="ignore_update  inline-icon-manashaddi <?php echo $ignored_class;  ?>" data-id="<?php echo $value['profile_id'];  ?>" ><i class="fa fa-times-circle" style="color:#ff5a60"data-toggle="tooltip" data-placement="top" title="Ignore Profile"></i></p>
