       ...
       <?php }else{ ?>
        ...
        <?php 
               ...
               <div class="person-details">
                  ...
                  <div class="col-md-8">
                     <div class="candidate-information">
                        <div class="fx">
                           <h4 class="wd-70"><?php echo $get_my_shortlist['primary'][$i][0]['first_name'] . ' ' . $get_my_shortlist['primary'][$i][0]['last_name'];?><span> (ID:<?php echo $get_my_shortlist['primary'][$i][0]['profile_id'];?>)</span></h4>
           ...
           ?>
                        ...
                        <div class="user_action" style="padding:10px;">
                        ...
                        <a><i class="fa fa-phone-square <?php echo $contact_class;  ?> " aria-hidden="true"></i>
                            <?php 
                            if(count($payment_details)>0){ ?>
                            
                           <button class="btn btn-primary ex-p contact_now" data-id="<?php echo $get_my_shortlist['primary'][$i][0]['profile_id'];  ?>" >Contact Now</button>
                           
                           <?php }else{ ?>
                           
                           <button class="btn btn-primary ex-p update-contact-now" data-id="<?php echo $get_my_shortlist['primary'][$i][0];  ?>" >Contact Now</button>
