   ...
   <div class="main container-fluid">
      <div class="">
		  ...
		  <div class="userbox-ms">
                        ...
                        <img src="<?php echo site_url();?>images/profilepics/<?php echo $profile_pic[0]['image']; ?>" width="80px" height="80px" style=" border: solid 1px #e7e7e7; padding: 4px">
                        <?php }else{ ?>
                        <img src="<?php echo site_url();?>assets/images/user.jpg" width="80px" height="80px" style=" border: solid 1px #e7e7e7; padding: 4px" >
                        <?php } ?>

               </div>
			                  <ul class="col-xs-9 profile-menu-ms">
                    <li><a href="<?php echo site_url(); ?>dashboard"> Edit Profile</a><li>
                    <li><a href="<?php echo site_url(); ?>dashboard/imagesinfo">  Manage Photo</a><li>
       ...
       <?php 
               ...
               <?php if(isset($get_all_records) && count($get_all_records) >0) { foreach($get_all_records as $value){ ?>
                  ...
                  <div class="col-md-12 person-details">
                    ...
                    <div class="col-xs-8 pull-right" style="padding:10px 5px">
						...
						<div class="col-xs-4 viewProfile-ms"><a href="<?php echo site_url();?>dashboard/search/profile/<?php echo $value['profile_id'];?>" data-id="<?php echo $value['profile_id'];  ?>" target="_blank" class="details">View Profile</a> </div>
                        </div>
                        <div class="col-md-12 content-ms">
           ...
           ?>
                        ...
                        <p class="view_update inline-icon-manashaddi" data-id="<?php echo $value['profile_id'];  ?>" ><i class="fa fa-eye <?php echo $view_class;  ?>"></i></p>
                        <p class="shortlist_update  inline-icon-manashaddi" data-id="<?php echo $value['profile_id'];  ?>" ><i class="fa fa-bookmark <?php echo $shortlist_class;  ?>"></i></p>
                        <p class="ignore_update  inline-icon-manashaddi" data-id="<?php echo $value['profile_id'];  ?>" ><i class="fa fa-times-circle <?php echo $ignored_class;  ?>"></i></p>
                        
						<div class="col-xs-12">&nbsp;</div>
						<div class="col-xs-6 ex-p no-padding">Like This Profile</div>
						...
						<a>
                           ...
                           <p class="ex-p col-xs-12 contact_now" data-id="<?php echo $value['profile_id'];  ?>" ><i class="fa fa-phone-square <?php echo $contact_class;  ?> " aria-hidden="true"></i> Contact Now</p>
                           
                           <?php }else{ ?>
                           
                           <a  class="ex-p col-xs-12 update-contact-now" data-id="<?php echo $value['profile_id'];  ?>" > <i class="fa fa-phone-square <?php echo $contact_class;  ?> " aria-hidden="true"></i> Contact Now</a>
