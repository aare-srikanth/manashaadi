                  ...
                  <div class="form-group ol-xs-12 col-md-6">
                     ...
                     <select class="form-control" id="maritalstatus" name="maritalstatus">
                      ...
                      Status</option>
                           ...
                           <option value="never_married" <?php if($preference_details['p_marital_status']=='never_married'){ echo 'selected'; } ?> >Never Married</option>

                           <option value="divorced" <?php if($preference_details['p_marital_status']=='divorced'){ echo 'selected'; } ?> >Divorced</option>

                           <option value="widow-widower" <?php if($preference_details['p_marital_status']=='widow-widower'){ echo 'selected'; } ?>>Widow / Widower</option>

                           <option value="separated" <?php if($preference_details['p_marital_status']=='separated'){ echo 'selected'; } ?>>Separated</option>

                           <option value="annulled" <?php if($preference_details['p_marital_status']=='annulled'){ echo 'selected';  } ?>>Annulled</option>
                  ...
                  <div class="ol-xs-12 col-md-6">
                     ...
                     <select class="form-control" id="mothertounge" name="mothertounge">
                       ...
                       <option value="">Select Mother Tongue</option>
                        ...
                        <option <?php if($preference_details['p_mother_tongue']==$value['mothertounge']){ echo 'selected';  } ?> value="<?php echo $value['mothertounge'];?>"><?php echo stripcslashes($value['mothertounge']);?></option><?php } >
