            ...
            <div class="ct-sliderPop-container">
                <div class="ct-sliderPop ct-sliderPop-slide1 open">
                    <div class="inner">
                        ...
                        <div class="row" style="margin-left:170px;"> Raasi : <?php echo stripcslashes($value['raasi']); ?></div><br>
                    ...
                    <div class="result-body">
                        <div class="row d-flex justify-content-center" style="font-size:12px;">
                            <div class="col-5 border" style="float:left;padding:20px;">
								...
								<div class="row" style="margin-left:10px;"><b> Tob : </b><?php echo stripcslashes($value['time_of_birth']); ?></div></br>
                                <div class="row" style="margin-left:10px;"><b> Star : </b><?php echo stripcslashes($value['star']); ?></div></br>
                                <div class="row" style="margin-left:10px;"><b> Raasi :</b> <?php echo stripcslashes($value['raasi']); ?></div></br>
                                <div class="row" style="margin-left:10px;"><b> Education : </b><?php echo stripcslashes($value['education_degree']); ?></div></br>
                                <div class="row" style="margin-left:10px;"><b> Profession : </b><?php echo stripcslashes($value['occupation']); ?></div></br>
                                <div class="row" style="margin-left:10px;"><b> Monthly Salary : </b><?php echo stripcslashes($value['annual_income']); ?></div></br>
                                <div class="row" style="margin-left:10px;"><b> Job Location : </b><?php echo stripcslashes($value['country']); ?></div></br>
                                <?php if ($value['visatype'] != "") { ?>
                                    <div class="row" style="margin-left:10px;"><b> Visa Status : </b><?php echo stripcslashes($value['visatype']); ?></div>
                                <?php } ?></br>
                                <div class="row" style="margin-left:10px;"><b> Father Native : </b><?php echo stripcslashes($value['fathers_father_district']); ?></div></br>
                                <div class="row" style="margin-left:10px;"><b> Mother Native : </b><?php echo stripcslashes($value['mothers_father_district']); ?></div></br>
                                <div class="row" style="margin-left:10px;"><b> Property : </b><?php echo stripcslashes($value['property_value']); ?> ( Lakhs )</div></br>
                                <hr>
