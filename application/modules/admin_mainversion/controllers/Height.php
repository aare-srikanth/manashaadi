...
class Height extends CI_Controller {
	...
	public $addPage    = 'height-add';	   
	public $editPage   = 'height-edit';   
	public $listPage   = 'height';		  

	public $listPage_redirect = '/admin/Height';		 
	public $addPage_redirect  = '/admin/Height/add/';	
	public $editPage_redirect = '/admin/Height/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Height_model','my_model');  
