...
class Star extends CI_Controller {
	...
	public $addPage    = 'star-add';	   
	public $editPage   = 'star-edit';   
	public $listPage   = 'star';		  

	public $listPage_redirect = '/admin/Star';		 
	public $addPage_redirect  = '/admin/Star/add/';	
	public $editPage_redirect = '/admin/Star/edit/';  

	public function __construct() 
	{
        parent::__construct();
  		$this->load->model('Star_model','my_model');  
