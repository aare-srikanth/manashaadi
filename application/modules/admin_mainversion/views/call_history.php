...
<style>
    #cust_call_log_list {  list-style-type: none;  height:95%; overflow: auto;  margin-left:-30px; color:black;   }
...
<!-- search area start  -->
<div style=" width:100%; float:left; font-size:1vw;display:flex; align-items: center; justify-content: center;"> 
    ...
    <div style="float:left; margin-right:1vw;">
        <div class="form-group form-inline">
            ...
            <input type="text" class="form-group form-control" style="width:100px;" id="dor_from" /> 
        </div>
    </div>
    ...
    <div style="float:left; margin-right:1vw;">
        <div class="form-group form-inline">
            ...
            <input type="text" class="form-group form-control" style="width:100px;" id="dor_to" />
        </div>
    </div>
...
<div id="user_profile_result" style="width: 100%; float:left; margin-bottom:20px;height:80%;">

    <!-- previouse profile selection start -->
    <div style="width:4%; height:100%; float:left; right:0px;">
        <span class="btn btn-warning" style="position: absolute;top: 50%;font-size:1vw; " id="prof_prev_action">Prev</span>
    </div>
    ...
    <div id="prof_display" style="width:92%;float:left;height:100%; ">
        ...
        <div id="cust_profile_info" style="font-size:0.8vw; width:30%; margin-left:2%; padding-top:20px; float:left;  border: 1px solid gray; padding-bottom:2vw;" >
        ...
        <div id="cust_call_history" style="width:60%; margin-left:4vw; margin-right:2%; float:left; height: 100%; border: 1px solid gray;">
            ...
            <div style="width:100%; height: 80%;float:left;">
                ...
                <!-- call data start -->
                <div class="cust_call_hsitory_list list-group" style=" width: 100%; float:left; margin-top: 20px;">
...
<script>
    $(document).ready(function() {  
        ...
        function loadEmployeeData(){
            $.ajax({
                type: "POST",	
                url: "<?php echo base_url(); ?>index.php/ws/get_employees", 
                dataType: 'json',
        ...
        $('#search_prof_emp').click(function(){
            ...
            $.ajax({
                type: "POST",	
                url: "<?php echo base_url(); ?>index.php/ws/get_association_search", 
                dataType: 'json',
                data:{
                    emp_id: em_selected,
                    dor_from: dor_from,
        ...
        function loadProfileList(){
            $.ajax({
                type: "POST",	
                url: "<?php echo base_url(); ?>index.php/ws/get_emp_associate_profiles", 
                dataType: 'json',
                data:{
        ...
        function getUserInormation(userId) {
            ...
            $.ajax({
                type: "POST",	
                url: "<?php echo base_url(); ?>index.php/ws/get_user_info", 
                dataType: 'json',
                data:{
                    user_id:userId
                },
        ...
        $('#btn_save_reg_fee').click(function(e){
            ...
            $.ajax({
                type: "POST",	
                url: "<?php echo base_url(); ?>index.php/ws/save_customer_reg_fee", 
                dataType: 'json',
                data:{
        ...
        $('#btn_save_sa_fee').click(function(e){
            ...
            $.ajax({
                type: "POST",	
                url: "<?php echo base_url(); ?>index.php/ws/save_customer_sa_fee", 
                dataType: 'json',
                data:{
                    cust_profile_id:cust_profile_id,
                    cust_sa_fee:sa_fee
        ...
        function get_chat_logs(){
            ...
            $.ajax({
                type: "POST",	
                url: "<?php echo base_url(); ?>index.php/ws/get_call_log", 
                dataType: 'json',
                data:{
                    cust_id : cust_id
                },
                    ...
                    if(result.success == "1")
                    {
                        ...
                        list.forEach(function(element){
                            ...
                            if(element.cl_type == "cl_type_outgoing"){
                                list_items += '<li class="list-group-item list-group-item-success">';
                                list_items += '<div class="card">';
                                ...
                                list_items += '<li class="list-group-item list-group-item-warning">';
                                list_items += '<div class="card">';
                                list_items += '<div class="card-body">';
                                ...
                                list_items += '<li class="list-group-item list-group-item-info">';
                                list_items += '<div class="card">';
                                list_items += '<div class="card-body">';
        ...
        $('#btn_save_call_log').click(function(e){
            ...
            if(cl_description ==''){
                ...
                $.ajax({
                type: "POST",	
                url: "<?php echo base_url(); ?>index.php/ws/save_call_log", 
                dataType: 'json',
                data:{
                    cl_type: cl_type,
        ...
        $('#btn_save_reminder').click(function(e){
            ...
            $.ajax({
                type: "POST",	
                url: "<?php echo base_url(); ?>index.php/ws/save_reminder", 
                dataType: 'json',
                data:{
                    cust_id : cust_id,
