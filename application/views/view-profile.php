...
<!-- /. NAV SIDE  -->
<div class="col-xs-12 no-padding" style="background:#f3f3f3;"> 
...
<div class="modal" id="salonMail" style="display: none;" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content-emailus">
                  <!-- Modal Header -->
                 ...
                 <!-- Modal body -->
                                  ...
                                  <div class="form-group">
                                      <button type="button" class="btn btn-danger" class="modal_close">Close</button>
                                  </div>
